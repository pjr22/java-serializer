...
public class CollectionFactory {
    ...
    /**
     * Creates a collection instance appropriate for specified field type.
     *
     * @param <T> type of elements in the collection
     * @param fieldType class type of field (may be an interface or concrete class)
     * @return a new collection instance of appropriate type
     * @throws IllegalArgumentException if field type is not a collection type
     */
